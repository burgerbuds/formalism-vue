<template>
    <div class="f-input" :class="[containerClass, `f-input--${theme}`]">
        <label class="f-input__inner">
            ...
            <span class="f-input__label"><span class="f-input__label-text" v-html="label"></span></span>
            <span class="f-input__indicator f-input__indicator--required" aria-hidden="true" v-if='required'>*</span>
        </label>
        <div class="f-input__message f-input__message--error" v-if="errorMessage" v-html="errorMessage">
        </div>
        <div class="f-input__message f-input__message--instruction" v-if="instructionMessage" v-html="instructionMessage">
        </div>
    </div>
</template>
